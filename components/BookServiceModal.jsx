    ...
    return (
        ...
        >
            <div className="flex flex-col gap-5 text-slate-700 w-full max-w-sm mx-6">
                ...
                <button disabled={submitting} className="bg-emerald-900 text-white text-sm font-medium py-2.5 rounded-md hover:bg-emerald-950 active:scale-95 transition-all disabled:opacity-60">
                    REQUEST BOOKING
                </button>
            </div>
